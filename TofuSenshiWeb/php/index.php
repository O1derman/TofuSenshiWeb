...
$provider = new TwitchProvider([
    'clientId'                => '<z3y6t0eayya49966gwhfkvs83zxgcp>',     // The client ID assigned when you created your application
    'clientSecret'            => '<an9kx728fkd8t5gmsa2m5oxkcrhqai>', // The client secret assigned when you created your application
    'redirectUri'             => '<http://localhost:8080/TofuSenshiWeb/>',  // Your redirect URL you specified when you created your application
    'scopes'                  => ['Congratulations, you logged in!']                // The scopes you would like to request 
]);
